  ...
  <div class="login-wrap">
    <el-form class="login-container" :model="user" :rules="rules" ref="userForm">
      ...
      <el-form-item label="账号:" prop="userNum">
        <el-input type="text" v-model="user.userNum" placeholder="登录账号" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="密码:" prop="password">
        <el-input type="password" v-model="user.password" placeholder="登录密码" autocomplete="off" show-password></el-input>
      </el-form-item>
